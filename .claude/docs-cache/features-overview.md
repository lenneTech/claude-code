...
<Tabs>
  ...
  <Tab title="Code intelligence">
    ...
    **Context cost:** Low. Symbol lookups often replace broad file reads, so net context use can go down.
    ...
    <Tip>The LSP tool is inactive until you install a [code intelligence plugin](https://code.claude.com/docs/en/plugins/code-intelligence) for your language.</Tip>
  </Tab>
