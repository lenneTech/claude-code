...
> **Generated:** 2026-09-25T11:44:16.734Z
...
- For complete API details, see [reference.md](https://code.claude.com/docs/en/reference.md)
- For usage examples, see [examples.md](https://code.claude.com/docs/en/examples.md)
```
