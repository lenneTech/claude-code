...
| `/lt-dev:review` | Code review after implementation: proven Critical/High defects, fixed automatically |
...
1. `/lt-dev:review $ARGUMENTS` — Code review: proven Critical/High defects, fixed automatically
