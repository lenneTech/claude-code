...
| Tool | Use Case |
|------|----------|
| `mcp__plugin_lt-dev_chrome-devtools__navigate_page` | Navigate to URL |
| `mcp__plugin_lt-dev_chrome-devtools__take_snapshot` | Get page structure with UIDs (preferred) |
| `mcp__plugin_lt-dev_chrome-devtools__take_screenshot` | Visual verification |
| `mcp__plugin_lt-dev_chrome-devtools__click` / `fill` | Interact with elements |
| `mcp__plugin_lt-dev_chrome-devtools__list_console_messages` | Check for JS errors |
...
│     mcp__plugin_lt-dev_chrome-devtools__navigate_page(url: "localhost:3001") │
│                                                                │
